...
## <span id="1"> 一 基本知识 </span>
 
### <span id="1.1"> 1.1 基本表单结构 </span>

1 HTML表单 允许用户将数据发送到 web站点(服务器)

2 HTML表单由一个或多个小组件构成，常见的表单元素结构见下:
...
&emsp;&emsp;[1.1 MDN— 创建第一个表单](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Forms/Your_first_HTML_form)

&emsp;&emsp;[1.2 MND— 构造HTML表单](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Forms/How_to_structure_an_HTML_form)


&emsp;&emsp;[02 09-5视频;](xxx)